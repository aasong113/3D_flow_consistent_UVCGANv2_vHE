...
def get_transfer_preset(cmdargs):
    ...
    if cmdargs.base_model is not None:
        ...
        pretrain_root = (
         '/home/durrlab/Desktop/Anthony/UGVSM/3D_flow_consistent_UVCGANv2_vHE/scripts/20260217_Inverted_BIT2HE_crypts_duo_train_OG/20251225_Inverted_combined_BIT2HE_duodenum_crypts_pretrain/model_m(autoencoder)_d(None)_g(vit-modnet)_pretrain-uvcgan2')
