...
def get_transfer_preset(cmdargs):
    ...
    if cmdargs.base_model is not None:
        ...
        pretrain_root = (
         '/home/durrlab/Desktop/Anthony/UGVSM/3D_flow_consistent_UVCGANv2_vHE/scripts/20260219_Inverted_BIT2HE_crypts_submucosa_train/20260108_Inverted_combined_BIT2HE_muscularis-submucosa_pretrain/model_m(autoencoder)_d(None)_g(vit-modnet)_pretrain-uvcgan2')
