...
DEFAULT_ROOT_DATA_PATH="/home/durrlab/Desktop/Anthony/data/20251209_kidney_tumor_all"
...
LAMBDA_MULTISCALE_CONTENT="${LAMBDA_MULTISCALE_CONTENT:-0.5}"
MULTISCALE_NUM_CHANNELS="${MULTISCALE_NUM_CHANNELS:-16}"
MULTISCALE_SCALES="${MULTISCALE_SCALES:-enc1,enc2,enc3,vit}" # "enc1", "enc2", "enc3", "vit"
LAMBDA_STYLE_LOSS="${LAMBDA_STYLE_LOSS:-0.5}"
...
TRAIN_PY="/home/durrlab/Desktop/Anthony/UGVSM/3D_flow_consistent_UVCGANv2_vHE/scripts/20260221_Inverted_BIT2HE_kidney_tumor/train_3D_embedding_style_content_TM.py"
