...
DEFAULT_ROOT_DATA_PATH="/home/durrlab/Desktop/Anthony/data/duodenum_crypts_lieberkuhn_MUSE_BIT"
...
MULTISCALE_SCALES="${MULTISCALE_SCALES:-enc1,enc2,enc3,vit}"
LAMBDA_STYLE_LOSS="${LAMBDA_STYLE_LOSS:-0.0}"

USE_STYLE_FUSION="${USE_STYLE_FUSION:-0}"
...
TRAIN_PY="/home/durrlab/Desktop/Anthony/UGVSM/3D_flow_consistent_UVCGANv2_vHE/scripts/train_3D_embedding_style_content_TM.py"
